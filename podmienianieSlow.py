...
file1_w = open(r'/Users/michalczarnik/Git_Project/Python_2022/Zloty_changed.txt', 'w')
file2_r = open(r'/Users/michalczarnik/Git_Project/Python_2022/Warszawa.txt', 'r')
file2_w = open(r'/Users/michalczarnik/Git_Project/Python_2022/Warszawa_changed.txt', 'w')
text1 = file1_r.read()
text2 = file2_r.read()
